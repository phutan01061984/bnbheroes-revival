...
- No runtime/gameplay asset or mapping was changed in this final archaeology pass. Next gate: run `npm run forensics:all`; if PASS, commit/push only curated docs/proofs plus the already-completed historical-state browser certification docs/evidence.
