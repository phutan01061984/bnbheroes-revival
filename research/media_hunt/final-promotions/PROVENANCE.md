...
## `fight.42bbd04e.png` — CREATIVE_RECONSTRUCTION
- Runtime dimensions: 512×512.
- Direct original byte remains unrecovered after legacy GitBook enumeration, old-host/archive searches, period video/screenshot review, bot-assets review and bundle embedded-image extraction.
- Current runtime image is the existing crossed-weapons reconstruction, normalized to 8-bit PNG only in this checkpoint.
- **Do not claim this file is original or period-derived.** It remains the only one of this six-file queue without period pixels promoted into the runtime artwork.
...
- `fight.42bbd04e.png`: `158f9f06f9f5720f884d97bd954fbea2029034a2b79c81405fc868a515791bf0`
