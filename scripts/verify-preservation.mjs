...
for (const p of [
  ...
  'archive/pre-result-browser-crop-fix-20260904/You lose.00f95b2b.png',
  'archive/pre-result-browser-alpha-fix-20260904/You lose.00f95b2b.png',
...
const resultExpected = {
  ...
  'static/media/You lose.00f95b2b.png': '0e2369ac0879584ff11584fe49a682736e60a416206b8d9197a491aeec096d9f'
};
...
const browserCropRejectedLoseHash = hashFile('archive/pre-result-browser-crop-fix-20260904/You lose.00f95b2b.png');
const browserAlphaRejectedLoseHash = hashFile('archive/pre-result-browser-alpha-fix-20260904/You lose.00f95b2b.png');
...
if (browserCropRejectedLoseHash === '1ef7f8406e38bb1643e9df5c366fa672b18638c9a5082566405a2627be01324c')
  ok('browser-rejected Lose residual crop/alpha intermediate remains archived');
else fail('Lose residual crop/alpha archive changed');
if (browserAlphaRejectedLoseHash === '9f54476dc22af25fa45faccf82c510f699f6e3517222152562a402275ff0e107')
  ok('browser-rejected Lose rectangular glow-alpha intermediate remains archived');
else fail('Lose rectangular glow-alpha archive changed');
